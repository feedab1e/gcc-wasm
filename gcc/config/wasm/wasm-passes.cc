...
{
  static void put_label (function *, rtx_insn *l, int &idx)
  {
    gcc_assert (!labels_to_cfno.put (l, idx++));
    int n = CODE_LABEL_NUMBER (l);
    gcc_assert (!labelno_to_labels.put (n, l));
  }
...
public:
  ...
  {
    labels_to_cfno.empty ();
    labelno_to_labels.empty ();
    basic_block bb;
